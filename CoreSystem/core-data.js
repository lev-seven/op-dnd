...
var CORE_RULES = {
  ...
  spellSlotCosts: {ct:0, 1:1, 2:2, 3:2, 4:3}, // L1-L2 costano 1 slot, L3-L4 costano 2 slot
  shortRestSlotRecovery: 'max(1, floor(max(MENTE,ANIMA)/3))',
  baseMovement: 9,
  // Armi: illimitate, bonus fisso per categoria. Perk Sintonia: usa max(CORPO,MENTE,ANIMA) per attacchi
  // Magie: più forti, ma consumano slot-punti
  weaponBonus: { A:1, B:2, C:3, D:4, DX:5 },
  spellBonus:  { ct:'0/1/2 (base/gate_mb/gate_ma)', 1:2, 2:4, 3:6, 4:8 },
  spellCost:   { 1:1, 2:2, 3:2, 4:3 },
...
A:[
  ...
  {id:'a_sin',nome:'Sintonia',stile:'universale',
   desc:'1x/riposo breve: usa MENTE o ANIMA invece di CORPO per 1 tiro di attacco con questa arma. Utile per chi bilancia piu statistiche.',
   pro:'Flessibilita sul tiro di attacco. Permette build ibride senza sacrificare nessuna stat.',
   con:'1 solo uso per riposo breve. Cat A - effetto limitato a singolo attacco.',
   evolveIn:'b_sin'},
...
B:[
  ...
  {id:'b_pre',nome:'Colpo Garantito',  stile:'universale',desc:'Danno minimo 3. 1x/riposo breve: ritira il dado se ottieni 1-3.',pro:'Affidabilità + ritiro emergenza.',con:'1 uso del ritiro per combat.',evolveIn:'c_pre',daId:'a_pre'},
  ...
  {id:'b_sin',nome:'Sintonia Superiore',stile:'universale',daId:'a_sin',
   desc:'2x/riposo breve: usa MENTE o ANIMA invece di CORPO per i tiri di attacco con questa arma.',
   pro:'Doppio uso. Ibridi e maghi-guerrieri possono mantenere la stat principale.',
   con:'2 usi per riposo breve. Senza riposo torna limitata.',
   evolveIn:'c_sin'}
,
  {id:'fa_b1',nome:'Lama Sacra Maggiore',stile:'fantasy', desc:'+2 danno vs oscurità. 1x/riposo breve: rimuovi 1 condizione oscura al colpo.',pro:'Molto forte in campagne horror/dark.',con:'Situazionale fuori contesto.',evolveIn:'fa_c1',daId:'fa_a1'},
  {id:'fa_b2',nome:'Runa Minore',      stile:'fantasy',   desc:'1x/riposo breve: imbui l\'arma con un elemento (fuoco/freddo/fulmine) per +1 danno di quel tipo.',pro:'Flessibilità elementale.',con:'Solo 1 uso, 1 tipo a volta.',evolveIn:'fa_c2'},
  ...
  {id:'no_b1',nome:'Fantasma',         stile:'noir',      desc:'Silenzioso. 1x/riposo breve: attacca da angolo cieco → +2 tiro, non riveli posizione.',pro:'Stealth offensiva + bonus colpo.',con:'1 uso.',evolveIn:'no_c1',daId:'no_a1'},
  {id:'no_b2',nome:'Parole Taglienti', stile:'noir',      desc:'1x/riposo breve: attacco verbale (portata voce) che infligge danno normale senza corpo a corpo.',pro:'Danno a distanza senza arco.',con:'1 uso, narrativamente vincolato.',evolveIn:'no_c2'},
...
C:[
  ...
  {id:'c_sto',nome:'Colpo Disabilitante',stile:'universale',desc:'Su colpo: applica Stordito 1 round 1x/riposo breve (bersaglio perde l\'azione).',pro:'Condizione grave, azione persa.',con:'1 uso.',evolveIn:'d_sto',daId:'b_sto'},
  ...
  {id:'c_dev',nome:'Devastazione',      stile:'universale',desc:'1x/riposo breve: tutti i nemici entro 1m subiscono metà del tuo danno.',pro:'Area di effetto in mischia.',con:'1 uso, raggio piccolo.',evolveIn:'d_dev'},
  {id:'c_sin',nome:'Sintonia Stabile',stile:'universale',daId:'b_sin',
   desc:'Passivo: puoi scegliere liberamente tra CORPO, MENTE o ANIMA per ogni tiro di attacco con questa arma. La scelta va dichiarata prima del tiro.',
   pro:'Passivo permanente. Un ibrido CORPO 7 MENTE 10 usa MENTE per tutti gli attacchi.',
   con:'Nessun effetto aggiuntivo oltre alla scelta della stat. Richiede dichiarazione preventiva.',
   evolveIn:'d_sin'}
,
  ...
  {id:'fa_c2',nome:'Runa Maggiore',     stile:'fantasy',  desc:'1x/riposo breve: +2 danno elementale + effetto (fuoco=brucia 1/r; freddo=Rallentato; fulmine=Stordito).',pro:'Danni + condizioni combinate.',con:'1 uso.',evolveIn:'fa_d2',daId:'fa_b2'},
  {id:'fa_c3',nome:'Anima dell\'Arma',  stile:'fantasy',  desc:'L\'arma è senziente: 1x/riposo breve avvisa di pericolo imminente (GM segnala).',pro:'Informazione narrativa potente.',con:'GM valuta il timing.',evolveIn:'fa_d3'},
  ...
  {id:'cy_c3',nome:'Modifica Adattiva', stile:'cyberpunk',desc:'1x/riposo breve: rimodella funzione arma (+2 a un tipo di attacco per 1 scena, GM approva).',pro:'Flessibilità situazionale enorme.',con:'1 uso. GM deve approvare.',evolveIn:'cy_d3'},
  ...
  {id:'ho_c2',nome:'Signore dei Non-Morti',stile:'horror',desc:'I non-morti ti ignorano. 1x/riposo breve: un gregario non-morto esegue 1 azione per te.',pro:'Controllo parziale non-morti.',con:'Solo gregari.',evolveIn:'ho_d2',daId:'ho_b2'},
  ...
  {id:'no_c1',nome:'Ombra Perfetta',    stile:'noir',     desc:'Attacchi sempre silenziosi. 1x/riposo breve: colpisci e rimani nascosto.',pro:'Stealth offensiva piena.',con:'1 uso del rimani-nascosto.',evolveIn:'no_d1',daId:'no_b1'},
  {id:'no_c2',nome:'Lingua Affilata',   stile:'noir',     desc:'1x/riposo breve: attacco verbale che infligge danno normale + Spaventato 1r OPPURE distrae 1 nemico 1r.',pro:'Danno + condizione o distrazione.',con:'1 uso, narrativo.',evolveIn:'no_d2',daId:'no_b2'},
...
D:[
  {id:'d_vel',nome:'Tempesta di Lame',  stile:'universale',desc:'+3 iniziativa. 1x/riposo lungo: attacca due volte nello stesso turno (seconda a -2).',pro:'Doppio attacco + massima init.',con:'-2 al secondo tiro.',daId:'c_vel'},
  {id:'d_pen',nome:'Sfondamento',       stile:'universale',desc:'Su colpo: ignora completamente la DEF del bersaglio per quel turno 1x/riposo lungo.',pro:'Danno netto su turno chiave.',con:'1 uso.',daId:'c_pen'},
  {id:'d_sto',nome:'Terrore Incarnato', stile:'universale',desc:'1x/riposo lungo: su colpo scegli tra Stordito 1r / Spaventato 2r / Rallentato 2r.',pro:'Condizione a scelta.',con:'Richiede di colpire.',daId:'c_sto'},
  ...
  {id:'d_res',nome:'Baluardo',          stile:'universale',desc:'+2 DEF + 1x/riposo lungo: reazione per dimezzare il danno di un attacco subito.',pro:'Difesa + salvataggio emergenza.',con:'1 uso del dimezza-danno.',daId:'c_res'},
  ...
  {id:'d_dev',nome:'Turbine',           stile:'universale',desc:'1x/riposo lungo: attacca TUTTI i nemici entro 3m con un singolo tiro.',pro:'Area enorme, bersagli multipli.',con:'1 uso.',daId:'c_dev'},
  ...
  {id:'d_sin',nome:'Sintonia Assoluta',stile:'universale',daId:'c_sin',
   desc:'Passivo: questa arma usa automaticamente la statistica piu alta tra CORPO, MENTE e ANIMA per ogni tiro di attacco, senza dichiarazione.',
   pro:'Completamente automatico. Maximizza sempre il potenziale offensivo indipendentemente dalla build.',
   con:'Occupa lo slot perk Cat D. Incompatibile con perk offensivi della lista D.'}
,
  {id:'fa_d1',nome:'Execrator',         stile:'fantasy',  desc:'+4 danno vs oscurità. 1x/riposo lungo: Giudizio → bersaglio perde condizioni positive e non le recupera per 2r.',pro:'Devastante vs oscurità.',con:'Situazionale.',daId:'fa_c1'},
  {id:'fa_d2',nome:'Runa Cosmica',      stile:'fantasy',  desc:'Danno elementale sempre attivo (scegli tipo). 1x/riposo lungo: +3 elementale + effetto a tutti entro 2m.',pro:'Danno elementale aoe.',con:'1 uso dell\'area.',daId:'fa_c2'},
  ...
  {id:'fa_d4',nome:'Ira degli Antichi', stile:'fantasy',  desc:'1x/riposo lungo: se danno > metà HP bersaglio → anche Spaventato 2 round.',pro:'Condizione enorme su colpo forte.',con:'1 uso, dipende dal danno.'},
  {id:'cy_d1',nome:'God Mode',          stile:'cyberpunk',desc:'1x/riposo lungo: disabilita TUTTO entro 5m (impianti, droni, armi tech) per 2 round.',pro:'Shutdown area totale.',con:'1 uso, solo vs tech.',daId:'cy_c1'},
  ...
  {id:'cy_d3',nome:'Protocollo Omega',  stile:'cyberpunk',desc:'1x/riposo lungo: l\'arma attacca autonomamente un secondo bersaglio a -2 senza usare la tua azione.',pro:'Attacco bonus senza azione.',con:'1 uso, -2 al tiro.',daId:'cy_c3'},
  ...
  {id:'ho_d2',nome:'Necromante Istintivo',stile:'horror', desc:'Controlli non-morti fino a tier normale. 1x/riposo lungo: controlla 1 elite per 1 scena.',pro:'Esercito di non-morti.',con:'1 uso elite per sessione.',daId:'ho_c2'},
  ...
  {id:'no_d1',nome:'Il Fantasma',       stile:'noir',     desc:'Sempre silenzioso e non rintracciabile. 1x/riposo lungo: diventa invisibile 1 round dopo aver colpito.',pro:'Invisibilità tattica.',con:'1 round, 1 uso.',daId:'no_c1'},
  {id:'no_d2',nome:'Artista della Parola',stile:'noir',   desc:'1x/riposo lungo: attacco verbale che colpisce TUTTI i nemici che possono sentirti con un tiro unico.',pro:'Danno area senza corpo a corpo.',con:'1 uso, solo chi sente.',daId:'no_c2'},
  ...
  {id:'no_d4',nome:'Il Prezzo del Silenzio',stile:'noir', desc:'1x/riposo lungo: se sei l\'unico testimone di un evento puoi riscriverne narrativamente l\'esito (GM approva).',pro:'Potere narrativo unico.',con:'1 uso, GM deve approvare.'},
  ...
  {id:'an_d4',nome:'Tecnica Suprema',   stile:'anime',    desc:'1x/riposo lungo: dichiara il nome della tecnica → il prossimo attacco è automaticamente critico se supera la DEF.',pro:'Critico garantito 1x/riposo lungo.',con:'1 uso. Deve superare la DEF.'},
],
DX:[
  {id:'dx_tra',nome:'Trascendenza',     stile:'universale',desc:'1x/riposo lungo: il prossimo attacco ignora completamente la DEF del bersaglio.',pro:'Danno netto assoluto.',con:'Non aumenta il tiro, solo ignora DEF.'},
  {id:'dx_dre',nome:'Drenaggio Vitale', stile:'universale',desc:'Su ogni colpo riuscito: recuperi HP pari al danno inflitto diviso 3 (minimo 1, arrotondato).',pro:'Sostentamento massimo in combat.',con:'Dipende dal danno inflitto.'},
  {id:'dx_fra',nome:'Frattura',         stile:'universale',desc:'1x/riposo lungo: il bersaglio non può usare abilità speciali, magie o perk per 2 round.',pro:'Shutdown completo 2 round.',con:'1 uso.'},
...
var SPELLS = [
  ...
  {id:'m18',tipo:'mg',lvl:3,min:10,stat:'MENTE',stile:'universale',nome:'Volo',             bonus:6,mec:'Il corpo si alleggerisce fino a diventare quasi senza peso. Per tre round puoi muoverti in qualsiasi direzione tridimensionale a velocità normale -- su, di lato, in diagonale. Puoi planare anche in caso di caduta.',                                       pro:'Mobilità aerea.',                  con:'Attacchi fisici lo annullano.'},
  {id:'m19',tipo:'mg',lvl:1,min:6,stat:'ANIMA',stile:'fantasy',  nome:'Benedizione',       bonus:2,mec:'Invochi una benedizione genuina su un alleato o su te stesso. Per due round il bersaglio ottiene più uno a tutti i tiri di qualsiasi tipo. Non cumulabile con altre benedizioni attive dello stesso tipo.',                          pro:'Buff di gruppo.',                  con:'Richiede alleati vicini.'},
  {id:'m20',tipo:'mg',lvl:1,min:6,stat:'ANIMA',stile:'fantasy',  nome:"Legame dell'Anima", bonus:2,mec:'1d12+ANIMA+4: condividi metà del danno ricevuto da 1 alleato.',              pro:'Protezione per alleato.',          con:'Rischioso se alleato subisce tanto.'},
  ...
  {id:'m32',tipo:'mg',lvl:2,min:8,stat:'ANIMA',stile:'anime',    nome:'Grido di Guerra',  bonus:4,mec:'Emetti un grido che incanalai la volontà di combattimento pura. Tutti gli alleati entro dieci metri che possono sentirti ottengono più uno al danno su ogni attacco per due round. Non cumulabile con un secondo Grido attivo.',             pro:'Buff massiccio.',                  con:'Dura 2 round.'},
  ...
  {id:'m53',tipo:'mg',lvl:2,min:8,stat:'ANIMA',stile:'universale',nome:'Scudo di Gruppo', bonus:4,mec:'Estendi una barriera di forza arcana su tutti gli alleati entro quindici metri. Fino al tuo prossimo turno, ogni alleato coperto da questa magia ottiene più due alla Difesa contro il prossimo attacco che riceve.',        pro:'Buff difensivo di gruppo.',        con:'Costa azione.'},
  ...
  {id:'m40',tipo:'mg',lvl:3,min:10,stat:'ANIMA',stile:'horror',   nome:"Sacrificio d'Anima",bonus:6,mec:'Spendi 2 HP per ogni 1 HP curato agli alleati in raggio. 1x/riposo.',      pro:'Healing massiccio.',               con:'Costa i tuoi HP.'},
...
var TALENTS = [
  ...
  {id:'t02',cat:'corpo',stile:'universale',req:null,nome:'Colpo Preciso',       desc:'Sai esattamente dove colpire quando l\'opportunita si presenta. Una volta per combattimento, quando il tuo attacco fisico supera la difesa del bersaglio, il danno inflitto e almeno 5 indipendentemente dalla differenza effettiva.',  pro:'1x/riposo lungo: danno fisico minimo garantito 5 su attacco riuscito.',               con:'1 solo uso. Non aggiunge danno se il risultato normale e gia superiore a 5.'},
  ...
  {id:'t15',cat:'mente',stile:'universale',req:null,nome:'Tattico',             desc:'In combattimento vedi opportunita che gli altri non colgono. Una volta per combattimento puoi reindirizzare come reazione l\'attacco di un alleato verso un bersaglio diverso o piu vulnerabile, senza consumare la sua azione.', pro:'1x/riposo lungo: ottimizza attacco alleato come reazione. Nessun costo per l\'alleato.',       con:'1 uso. Richiede coordinazione e il GM deve approvare la coerenza.'},
  ...
  {id:'t35',cat:'mente',stile:'universale',req:null,nome:'Adrenalina Innata',   desc:'C\'e un momento in ogni scontro in cui un singolo tiro decide tutto. Una volta per combattimento, prima che il dado smetta di rotolare, puoi dichiarare di ritirarlo e tenere il risultato migliore dei due tiri.',             pro:'1x/riposo lungo: ritira qualsiasi tiro, tieni il piu alto. Salva situazioni critiche.',   con:'1 solo uso per combattimento.'},
  {id:'t43',cat:'mente',stile:'horror',    req:null,nome:'Cultista',            desc:'Sei affiliato a una setta con accesso a conoscenze che la societa civile non approverebbe. MENTE +3 su rituali e riti oscuri. Una volta per sessione la setta fornisce una risorsa, un\'informazione o supporto pratico.',pro:'MENTE +3 riti oscuri. 1x/riposo lungo: supporto dalla setta (GM valuta l\'entita).',  con:'La setta ti osserva. Il GM puo assegnarti compiti non richiesti come conseguenza.'},
  ...
  {id:'t47',cat:'anima',stile:'anime',     req:null,nome:'Nakama',              desc:'Quando uno dei tuoi legami e in pericolo, qualcosa cambia in te. Una volta per combattimento, se un alleato scende sotto un terzo degli HP massimi, ottieni +4 a tutti i tuoi tiri per il round immediatamente successivo.',            pro:'1x/riposo lungo: +4 tiri per 1 round quando alleato scende sotto 1/3 HP.',       con:'Solo se un alleato e in pericolo reale. Inutile se combatti in solitaria.'},
  ...
  {id:'t27',cat:'ibrido',stile:'universale',req:null,nome:'Adattamento Rapido', desc:'La tua mente si adatta alle situazioni in modo insolito. Una volta per sessione, in accordo col GM, puoi usare una caratteristica diversa da quella normale per un\'azione specifica. Ad esempio: ANIMA invece di CORPO per un atto di forza compiuto con pura volonta.',            pro:'1x/riposo lungo: usa stat alternativa per 1 azione. Flessibilita narrativa massima.',         con:'1 uso. Richiede approvazione GM sulla coerenza della scelta.'},
  ...
  {id:'t49',cat:'ibrido',stile:'anime',   req:null,nome:'Tecnica Segreta',     desc:'Hai una tecnica personale con un nome e una storia. Una volta per sessione, dichiari il nome della tecnica e la applichi: il prossimo tiro ottiene +5. Deve essere narrativamente coerente col tipo di azione.',pro:'1x/riposo lungo: +5 al prossimo tiro. Il bonus singolo piu alto del sistema.',con:'1 uso. Narrativamente vincolato. Il GM puo negare usi non plausibili.'},
  {id:'t56',cat:'ibrido',stile:'fantasy',  req:null,nome:'Legame Familiare',    desc:'Hai un legame speciale con qualcuno. Una volta per combattimento, quando il legame e presente o visibilmente al sicuro, ottieni +2 a tutti i tiri per 2 round. Se il legame viene minacciato: +4 per 1 round.',pro:'1x/riposo lungo: +2 tiri x2r (o +4 x1r se il legame e in pericolo).',con:'Dipende dalla presenza del legame. Inutile in solitaria o se il legame e assente.'},
...
// ─── TALENTI AZIONE (nuovi: meccaniche da altri sistemi GDR) ───
  ...
  {id:'contrattacco',     cat:'corpo',  stile:'universale',req:'armi_pesanti',
    ...
    perk:'1x/riposo lungo: quando un nemico ti attacca in mischia e il suo tiro totale è inferiore alla tua Difesa, esegui immediatamente un attacco di risposta fuori dal tuo turno, con tutti i tuoi normali bonus. Non è possibile usare questa risposta contro attacchi a distanza o incantesimi.',
  ...
  {id:'zufolo_bardico',   cat:'anima',  stile:'universale',req:null,
    ...
    perk:'1x/riposo lungo: designa un alleato entro dieci metri. Prima che effettui il suo prossimo tiro, aggiunge al risultato un bonus pari al tuo valore di ANIMA. Puoi dichiararlo dopo che il dado è stato tirato ma prima che l\'esito venga risolto.',
  ...
  {id:'recupero_arcano',  cat:'mente',  stile:'universale',req:'gate_mb',
    ...
    perk:'1x/riposo lungo: durante o subito dopo un Riposo Breve, recuperi slot magici aggiuntivi pari alla metà del tuo valore di MENTE, arrotondato per difetto (minimo uno).',
  ...
  {id:'adrenalina_pura',  cat:'corpo',  stile:'universale',req:null,
    ...
    perk:'1x/riposo lungo: nel tuo turno, dopo aver già effettuato un attacco, esegui immediatamente un secondo attacco con gli stessi bonus. Non è utilizzabile quando sei in Stato Critico.',
  ...
  {id:'istinto_sopravvivenza',cat:'mente',stile:'noir',   req:null,
    ...
    perk:'Passivo: non puoi essere colto di sorpresa -- sei sempre presente nell\'iniziativa. 1x/riposo lungo, puoi dichiarare di notare qualcosa che normalmente richiederebbe un tiro di MENTE: il Master decide cosa e quanto dettaglio.',
  ...
  {id:'parole_piombo',    cat:'anima',  stile:'noir',     req:null,
    ...
    perk:'Puoi usare ANIMA al posto di CORPO per i tiri di intimidazione e per imporre condizioni psicologiche a bersagli intelligenti. 1x/riposo lungo: come azione, effettua un tiro di ANIMA contro la MENTE del bersaglio. In caso di successo, il bersaglio non ti attacca nel round corrente -- anche se è già in posizione di farlo.',
...
var AUGMENTS = [
  // CYBERPUNK
  {id:'aug_oc',stile:'cyberpunk',tipo:'Cyberware',nome:'Occhi Cybertici',desc:'Un paio di occhi sostituiti con sistemi ottici ad alta precisione. HUD integrato con overlay tattico in tempo reale, zoom ottico 10x, visione notturna e termica. Vedi nell\'oscurita come in piena luce.',pro:'+2 tiri MENTE visivi. Visione notturna.',con:'Visibili (LED). -1 ANIMA in contesti conservatori.',manutenzione:'Calibrazione mensile.',perk:'Scansione Tattica: 1x/riposo lungo, MENTE vs ANIMA per rivelare 1 stat nascosta del bersaglio.'},
  {id:'aug_bm',stile:'cyberpunk',tipo:'Cyberware',nome:'Braccio Meccanico',desc:'Un braccio potenziato con servoassistenza idraulica che moltiplica la forza erogabile senza sforzo percettibile. In mischia il risultato si traduce in prese immobilizzanti difficili da spezzare.',pro:'+2 CORPO attacchi fisici. Solleva il doppio.',con:'-1 ANIMA formale. -1 CORPO stealth.',manutenzione:'Calibrazione settimanale.',perk:'Presa Idraulica: 1x/riposo lungo, se colpisci in mischia il bersaglio è Rallentato 1 round.'},
  {id:'aug_rn',stile:'cyberpunk',tipo:'Cyberware',nome:'Riflessi Neurali',desc:'Il tuo sistema nervoso e stato ricablato con conduttori sinaptici artificiali che riducono i tempi di reazione a livelli meccanici. Il cervello elabora il pericolo e il corpo ha gia risposto.',pro:'+3 iniziativa. +1 difesa CORPO.',con:'Stress: CORPO vs 7 o Indebolito (MENTE). Incomp. Limitatore Rimosso.',manutenzione:'Soppressori mensili.',perk:'Schivata Reattiva: 1x/riposo lungo, nega un attacco che ti avrebbe colpito con margine <= 2.'},
  ...
  {id:'aug_in',stile:'cyberpunk',tipo:'Cyberware',nome:'Interfaccia Neurale',desc:'Un jack cranico discreto che permette connessione neurale diretta con qualsiasi sistema digitale compatibile. Dentro la rete, sei piu veloce di qualsiasi interfaccia manuale.',pro:'+3 MENTE vs sistemi digitali.',con:'Vulnerabile ad hacking (MENTE vs MENTE).',manutenzione:'Firmware mensile.',perk:'Download Rapido: 1x/riposo lungo, scarica info da sistema digitale come azione gratuita.'},
  ...
  {id:'aug_ov',stile:'fantasy',tipo:'Magico',nome:'Occhio del Veggente',desc:'Un terzo occhio nascosto nella fronte o nella nuca, frutto di chirurgia magica avanzata. Percepisce flussi di energia, tentativi di inganno e possibilita alternative prima che si concretizzino.',pro:'+2 MENTE tiri magici. Rilevi aure 10m.',con:'-1 ANIMA social. Visioni involontarie.',manutenzione:null,perk:'Preveggenza: 1x/riposo lungo, dichiara prima del tiro del nemico: il suo prossimo tiro ha -2.'},
  {id:'aug_rc',stile:'fantasy',tipo:'Runa',nome:'Rune Corporee',desc:'Rune di protezione e reazione sono state incise direttamente nella carne con inchiostro magico permanente. Attivano una risposta offensiva automatica quando sei colpito da vicino.',pro:'+2 difesa CORPO. Immune prima maledizione/sessione.',con:'Dispelling: -1 difesa/round. Visibili.',manutenzione:null,perk:'Runa Esplosiva: 1x/riposo lungo, reazione: chi ti colpisce in mischia subisce 3 danni.'},
  {id:'aug_ga',stile:'fantasy',tipo:'Bioware',nome:'Ghiandole Alchemiche',desc:'Ghiandole sintetiche impiantate producono e immagazzinano composti tossici su richiesta, rilasciabili attraverso il sudore o il contatto diretto durante un attacco.',pro:'1x/riposo: sostanza (veleno/acido/adrenalina/siero).',con:'Dieta specifica. Senza: -1 CORPO 1 ora.',manutenzione:'Dieta mensile.',perk:'Veleno Rapido: 1x/riposo lungo, il tuo prossimo attacco fisico infligge Avvelenato 2 round.'},
  // HORROR
  {id:'aug_pm',stile:'horror',tipo:'Patto',nome:'Patto col Morto',desc:'Hai stretto un accordo formale con un morto che non e ancora passato oltre. In cambio di qualcosa di non detto, ti sussurra segreti sulle intenzioni altrui.',pro:'1x/riposo lungo: info unica. +1 difesa ANIMA.',con:'Entità può interferire.',manutenzione:'Rispetta patti o -2 tiri.',perk:'Sussurro del Morto: 1x/riposo lungo, ANIMA vs ANIMA di un nemico, vinci: conosci la sua prossima azione.'},
  {id:'aug_cm',stile:'horror',tipo:'Biomod',nome:'Carne Modulata',desc:'Il tuo tessuto connettivo e stato reso parzialmente malleabile attraverso modifiche biologiche avanzate. Puoi rimodellare masse muscolari e arti per adattarli a compiti specifici nell\'arco di una scena.',pro:'Rimodella arto (Cat A, strumento, superficie).',con:'-1 ANIMA permanente. Temperature estreme: -2 tiri.',manutenzione:null,perk:'Adattamento: 1x/riposo lungo, rimodella un arto per ottenere +3 a un tipo di tiro CORPO per 1 scena.'},
  {id:'aug_nm',stile:'horror',tipo:'Neurologia',nome:'Nervo Morto',desc:'Una porzione del tuo sistema nervoso e stata deliberatamente desensibilizzata ai segnali di dolore. Continui a funzionare in condizioni che bloccherebbero fisicamente chiunque altro.',pro:'Immune penalità Ferito. +1 CORPO resistenza.',con:'Non senti danni minori. Ferite nascoste (GM).',manutenzione:null,perk:'Resistenza al Dolore: 1x/riposo lungo, ignora una condizione per 1 round.'},
  {id:'aug_sc',stile:'horror',tipo:'Patto',nome:'Sigillo Corrotto',desc:'Un sigillo magico oscuro e stato inciso nella tua pelle da qualcuno che conosceva rituali che non avrebbe dovuto conoscere. Trasferisce parte del malfunzionamento arcano su chi ti colpisce.',pro:'+2 a tipo tiro scelto. Sempre attivo.',con:'Ad ogni uso: d6, su 1 entità guarda attraverso te.',manutenzione:null,perk:'Marchio Ardente: 1x/riposo lungo, il bersaglio che colpisci subisce -1 a tutti i tiri per 2 round.'},
  {id:'aug_mk',stile:'horror',tipo:'Patto Cosmico',nome:"Marchio dell'Antico",desc:'Il simbolo di un\'entita cosmica e stato impresso nella tua aura in modo permanente. Chi ti fissa troppo a lungo sente qualcosa di sbagliato -- qualcosa che non appartiene a questo piano.',pro:'+2 ANIMA vs entità cosmiche. Percepisci elder god 500m.',con:'-1 MENTE per sessione. Sogni cosmici.',manutenzione:'Rituali mensili.',perk:'Terrore Cosmico: 1x/riposo lungo, ANIMA vs ANIMA di tutti entro 5m, chi perde è Spaventato 1 round.'},
  {id:'aug_oc2',stile:'horror',tipo:'Biomod Cosmico',nome:'Occhio del Caos',desc:'Un occhio alieno di origine sconosciuta e stato impiantato in sostituzione di uno dei tuoi. Vede pattern che gli occhi umani filtrano automaticamente, comprese probabilita e possibilita imminenti.',pro:'+3 percezione soprannaturale. 50% futuro 1x/riposo lungo.',con:'-1 ANIMA permanente. Visioni non controllabili.',manutenzione:null,perk:'Visione del Caos: 1x/riposo lungo, 50% (d6 >= 4) di prevedere il prossimo tiro nemico e annullarlo.'},
  {id:'aug_sang',stile:'horror',tipo:'Rituale di Setta',nome:'Legame di Sangue',desc:'Il tuo sangue contiene frammenti di un rituale collettivo che ti connette psichicamente agli altri membri della setta in modo permanente. Quando hai bisogno di forza, loro la sentono.',pro:'Senti membri 1 km. +2 ANIMA rituali collettivi.',con:'Setta ti localizza sempre. GM ha accesso pensieri.',manutenzione:'Rito mensile.',perk:'Rete Psichica: 1x/riposo lungo, un membro della setta entro 1km ti dà +2 al prossimo tiro.'},
  {id:'aug_corp',stile:'horror',tipo:'Corruzione',nome:'Corruzione Benedetta',desc:'Il tuo corpo porta tracce visibili di corruzione magica -- vene che pulsano in colori sbagliati, cicatrici che cambiano forma. La corruzione pero e stata trasformata in energia offensiva.',pro:'+1 CORPO, +1 ANIMA. Rigenera 1 HP/round sotto metà HP.',con:'Rigenerazione: d6, su 1 tratto orrorifico. Non-umano.',manutenzione:null,perk:'Rigetto Violento: quando rigeneri HP, 1x/riposo lungo il nemico più vicino subisce 2 danni.'},
  {id:'aug_voc',stile:'horror',tipo:'Rituale di Setta',nome:"Voce dell'Abisso",desc:'Un rituale di setta ha modificato le tue corde vocali in modo permanente. A volte, quando parli, chi ascolta sente qualcosa di diverso da cio che hai detto -- qualcosa che vuole obbedire.',pro:'+3 ANIMA intimidazione. Vero Nome: entità non attacca 1 round.',con:'-2 ANIMA social normali. Attira attenzione entità.',manutenzione:null,perk:'Comando Abissale: 1x/riposo lungo, pronuncia un ordine: ANIMA vs ANIMA, il bersaglio esegue 1 azione semplice.'},
  // ANIME
  {id:'aug_lr',stile:'anime',tipo:'Neurologia',nome:'Limitatore Rimosso',desc:'Un blocco mentale artificiale che limitava le prestazioni fisiche e stato rimosso chirurgicamente. Il risultato e accesso a picchi di performance prima soppressi, a costo di una certa instabilita.',pro:'1x/riposo lungo: stat bonus x1.5 per 1 round.',con:'-5 HP dopo. Incomp. Riflessi Neurali / Gate dell\'Anima.',manutenzione:null,perk:'Sovraccarico: quando usi il Limitatore, il primo attacco del round extra ha +3.'},
  {id:'aug_fd',stile:'anime',tipo:'Biomod',nome:'Forma Duale',desc:'Una forma alternativa biologica dorme nel tuo DNA, attivabile con concentrazione. La trasformazione non e cosmetics: muta la struttura ossea e muscolare in qualcosa di piu adatto al combattimento.',pro:'1x/riposo lungo: +2 tiri, +2 HP temp per 3 round.',con:'Dopo: Indebolito (CORPO) 2 round. Aspetto cambia.',manutenzione:null,perk:'Metamorfosi Offensiva: nella Forma Duale, i tuoi attacchi fisici infliggono +2 danni.'},
  {id:'aug_ck',stile:'anime',tipo:'Spirituale',nome:'Core di Ki',desc:'Una riserva di energia spirituale e stata aperta e stabilizzata all\'interno del tuo corpo attraverso meditazione intensiva e rituale. Il ki e ora un serbatoio che puoi svuotare in esplosioni precise.',pro:'+2 attacchi magici. Usa stat più alta per magie.',con:'2 magie consecutive: -2 HP. Ki visibile.',manutenzione:null,perk:'Esplosione di Ki: 1x/riposo lungo, il tuo prossimo attacco magico colpisce anche 1 bersaglio adiacente.'},
  {id:'aug_asc',stile:'anime',tipo:'Ascensione',nome:'Forma Ascesa',desc:'Hai toccato la tua vera forma, anche solo brevemente. Nella forma ascesa irradi un\'aura che cambia la chimica del combattimento intorno a te -- il tuo gruppo combatte meglio semplicemente standoti vicino.',pro:'1x/riposo lungo: +4 tiri, +5 HP temp per 4 round. Attacchi magici.',con:'Dopo: Stordito 1 round, poi -3 tiri 2 round. No con Forma Duale.',manutenzione:null,perk:'Aura Divina: nella Forma Ascesa, alleati entro 5m hanno +1 a tutti i tiri.'},
  {id:'aug_spirit',stile:'anime',tipo:'Spirituale',nome:"Spirito dell'Arma",desc:'L\'arma che porti ha sviluppato una coscienza propria, forgiata dai combattimenti che avete condiviso. A volte agisce da sola, non perche sia magica, ma perche ha imparato.',pro:'+2 attacchi fisici. +1 iniziativa. 1x/riposo lungo nega critico.',con:'Spirito ha volontà propria (GM). Se distrutta: -bonus 1 sessione.',manutenzione:'Cura narrativa.',perk:'Risonanza: 1x/riposo lungo, l\'arma agisce da sola come azione bonus (Cat A, +2 attacco).'},
  ...
  {id:'aug_om01',stile:'fantasy',tipo:'Anello Magico',
    ...
    manutenzione:null,
    perk:'Scatto: 1x/riposo lungo, puoi agire prima di chiunque altro nel round corrente, indipendentemente dall\'iniziativa.'},
  ...
  {id:'aug_om02',stile:'fantasy',tipo:'Collana Magica',
    ...
    manutenzione:null,
    perk:'Scudo Cristallino: 1x/riposo lungo, nega un colpo critico subito.'},
  ...
  {id:'aug_om03',stile:'fantasy',tipo:'Pergamena',
    ...
    pro:'1x/riposo lungo, rivela tutte le creature invisibili, celate o travestite entro venti metri per un round.',
    ...
    perk:'Occhio Veggente: 1x/riposo lungo, rivela invisibili e nascosti entro 20m per un round.'},
  ...
  {id:'aug_dt02',stile:'cyberpunk',tipo:'Dispositivo Tecnologico',
    ...
    pro:'1x/riposo lungo, disabilita tutti i dispositivi elettronici entro cinque metri per un round.',
    ...
    perk:'Impulso EMP: 1x/riposo lungo, disabilita tutta l\'elettronica entro 5m per un round (inclusa la propria).'},
  ...
  {id:'aug_ni01',stile:'noir',tipo:'Strumento Investigativo',
    ...
    pro:'1x/riposo lungo, individua automaticamente un dettaglio nascosto o una prova che altrimenti richiederebbe un tiro difficile.',
    con:'Richiede almeno un minuto di esame -- inutile in combattimento o situazioni concitate.',
    manutenzione:null,
    perk:'Occhio da Detective: 1x/riposo lungo, il GM rivela un indizio o dettaglio nascosto nella scena esaminata.'},
  ...
  {id:'aug_hc01',stile:'horror',tipo:'Oggetto Maledetto',
    ...
    pro:'1x/riposo lungo, il GM mostra cosa è accaduto in questo luogo nelle ultime ventiquattro ore.',
    con:'Chi guarda troppo a lungo -- più di un minuto -- acquisisce la condizione Spaventato senza possibilità di tiro.',
    manutenzione:null,
    perk:'Visione del Passato: 1x/riposo lungo, il GM rivela un evento recente accaduto nel luogo corrente.'},
  ...
  {id:'aug_hc02',stile:'horror',tipo:'Oggetto Maledetto',
    ...
    pro:'1x/riposo lungo, infliggi due punti di danno a distanza illimitata a un bersaglio a cui appartiene il materiale biologico contenuto.',
    ...
    perk:'Maledizione a Distanza: 1x/riposo lungo, infliggi 2 danni a qualsiasi distanza al bersaglio legato.'},
  ...
  {id:'aug_hc04',stile:'horror',tipo:'Reliquia Maledetta',
    ...
    pro:'1x/riposo lungo, hai una visione profetica confusa su un evento imminente -- il GM fornisce un\'immagine criptica del futuro prossimo.',
    con:"Le visioni non si possono controllare -- arrivano anche di notte, interrompendo il sonno. Un Riposo Lungo non è garantito.",
    manutenzione:null,
    perk:"Profezia Confusa: 1x/riposo lungo, il GM fornisce un'immagine simbolica di qualcosa che accadrà entro la sessione corrente."},
  ...
  {id:'aug_lv02',stile:'horror',tipo:'Artefatto Cosmico',
    ...
    pro:'1x/riposo lungo, assumi perfettamente le sembianze di una persona che hai osservato per almeno un minuto. Voce e aspetto inclusi. Dura un\'ora.',
    ...
    manutenzione:null,
    perk:"Volto del Messaggero: 1x/riposo lungo, assumi le sembianze di chiunque tu abbia osservato di persona. Tiro ANIMA>=8 o conseguenze narrative."},
  ...
  {id:'aug_zm01',stile:'post-ap',tipo:'Composto Biologico',
    ...
    pro:'1x/riposo lungo: +3 CORPO e +5 HP temporanei per tre round. Dopo i tre round, -2 CORPO per un round.',
    ...
    perk:'Surge Biologico: 1x/riposo lungo, +3 CORPO e +5 HP temp per 3 round, poi -2 CORPO per 1 round. Tiro CORPO>=6 o furia.'},
...
var MONSTERS = [
  ...
  {id:'mon03',nome:'Drone da Combattimento',tier:'gregario',stile:'cyberpunk',corpo:3,mente:2,anima:1,hp:5,armaCat:'B',defBonus:1,competenza:null,talenti:[],magie:[],
   ...
   abilita:'Immune a Spaventato e Veleno. Vulnerabile a magie tecnologiche (-1 DEF contro impulsi EMP). Ricarica: se ucciso, 1x/riposo lungo un secondo drone identico puo arrivare (GM valuta).',
   speciale:null},
  ...
  {id:'mon04',nome:'Cavaliere Corrotto',tier:'normale',stile:'fantasy',corpo:7,mente:3,anima:2,hp:12,armaCat:'C',defBonus:3,competenza:'corpo',talenti:['armi_pesanti'],magie:[],
   ...
   abilita:'Armatura pesante +3 DEF. Competenza CORPO +3. 1x/riposo lungo: Carica -- attacca con +2 al tiro e spinge il bersaglio di 2m (se colpisce).',
  ...
  {id:'mon05',nome:'Cultista Maggiore',tier:'normale',stile:'horror',corpo:3,mente:4,anima:7,hp:14,armaCat:'B',defBonus:0,competenza:'anima',talenti:['gate_mb'],magie:['m07','m04'],
   ...
   speciale:'Benedizione di Sangue: se un alleato muore entro 5m, recupera 3 HP (1x/riposo lungo).'},
  {id:'mon06',nome:'Cyborg Mercenario',tier:'normale',stile:'cyberpunk',corpo:6,mente:5,anima:2,hp:12,armaCat:'C',defBonus:1,competenza:'corpo',talenti:['interfaccia_neurale'],magie:[],
   ...
   abilita:'Competenza CORPO +3. Impianti: +1 DEF, visione notturna. 1x/riposo lungo: Scarica EMP -- tutti i sistemi tecnologici entro 3m si riavviano (turno perso per chi li usa).',
   speciale:'Targeting Avanzato: 1x/riposo lungo, ignora bonus scudo del bersaglio su un attacco.'},
  {id:'mon_n4',nome:'Samurai Nemico',tier:'normale',stile:'anime',corpo:7,mente:3,anima:5,hp:13,armaCat:'C',defBonus:1,competenza:'corpo',talenti:['contrattacco'],magie:[],
   ...
   abilita:'Competenza CORPO +3. 1x/riposo lungo: Contrattacco -- se un attacco lo manca, risponde immediatamente con un attacco gratuito. DEF +1 (postura).',
  ...
  {id:'mon_n5',nome:'Detective Corrotto',tier:'normale',stile:'noir',corpo:4,mente:7,anima:4,hp:11,armaCat:'B',defBonus:0,competenza:'mente',talenti:['istinto_sopravvivenza'],magie:[],
   ...
   abilita:'Competenza MENTE +3. 1x/riposo lungo: Parole Taglienti -- tiro MENTE vs MENTE, se vince applica -1 al prossimo tiro del bersaglio (parole che destabilizzano). Sempre va per primo (alta INIT).',
  ...
  {id:'mon_n6',nome:'Vampiro',tier:'normale',stile:'horror',corpo:6,mente:4,anima:6,hp:14,armaCat:'B',defBonus:0,competenza:'corpo',talenti:['patto_abisso'],magie:['c14'],
   ...
   speciale:'Fascino Vampirico: 1x/riposo lungo, tiro ANIMA vs ANIMA -- se vince, bersaglio non attacca per 1 round (Charme).'},
  ...
  {id:'mon07',nome:'Drago Giovane',tier:'elite',stile:'fantasy',corpo:10,mente:6,anima:7,hp:23,armaCat:'D',defBonus:4,competenza:'corpo',talenti:['armi_letali','limite_ultimo'],magie:['m13'],
   ...
   abilita:'CORPO 10 + Armi Letali: Cat D. Competenza CORPO +5. Armatura naturale +4 DEF. Palla di Fuoco (L2, MENTE 6, +4 tiro, 1 slot). Soffio di Fuoco: attacco Cat D che colpisce tutti in un cono di 6m (1x/riposo lungo).',
  ...
  {id:'mon_e2',nome:'Vampiro Anziano',tier:'elite',stile:'horror',corpo:9,mente:7,anima:9,hp:20,armaCat:'C',defBonus:2,competenza:'anima',talenti:['patto_abisso','furia'],magie:['m07','c14','m26'],
   ...
   speciale:'Trasformazione: 1x/riposo lungo si trasforma in nebbia -- invulnerabile per 1 round, poi riemerge.'},
  {id:'mon_e3',nome:'Hacker Militare',tier:'elite',stile:'cyberpunk',corpo:5,mente:11,anima:4,hp:17,armaCat:'B',defBonus:0,competenza:'mente',talenti:['interfaccia_neurale','recupero_arcano'],magie:['m22','m33','c15'],
   ...
   speciale:'God Mode: 1x/riposo lungo, puo spegnere tutti i dispositivi tecnologici nell\'area (30m) per 2 round.'},
  {id:'mon_e4',nome:'Maestro del Dojo Nemico',tier:'elite',stile:'anime',corpo:9,mente:7,anima:8,hp:22,armaCat:'C',defBonus:2,competenza:'corpo',talenti:['contrattacco','furia','adrenalina_pura'],magie:['m50'],
   ...
   speciale:'Mille Pugni: 1x/riposo lungo, effettua 2 attacchi in un turno al -1 ciascuno.'},
  ...
  {id:'mon_b3',nome:'Sovrano dell Abisso',tier:'boss',stile:'horror',corpo:9,mente:12,anima:15,hp:40,armaCat:'C',defBonus:2,competenza:'anima',talenti:['gate_mb','gate_ma','patto_abisso','conoscenza_proibita'],magie:['m39','m41','m47','m30','c14','m07'],
   ...
   speciale:'Aura Abissale: tutti i PG a 5m subiscono -1 a tutti i tiri mentre sono in quella zona. Piena Manifestazione: 1x/riposo lungo, come azione bonus lancia gratuitamente una magia L1-L2 senza usare slot.'},
  ...
  {id:'mon_b5',nome:'Il Padrino',tier:'boss',stile:'noir',corpo:7,mente:13,anima:12,hp:32,armaCat:'B',defBonus:2,competenza:'anima',talenti:['istinto_sopravvivenza','parole_piombo','gate_mb','limite_ultimo'],magie:['m17','m26','m07'],
   ...
   speciale:'Rete di Contatti: 1x/riposo lungo, chiama rinforzi -- arrivano 2 Tirapiedi (gregari) al prossimo turno. Non Si Tocca: la prima volta che scende sotto 15 HP, un lacche si getta davanti assorbendo un attacco per lui (1x, narrativo).'}
];
...
var WEAPONS = [
  ...
  {id:'w_d01',upgradeOnly:true,nome:'Spadone',nomeLore:'Spezzamondi',cat:'DX',tipo:'Spada',     stile:'fantasy',
   ...
   perkSpeciale:{nome:'Furia Solare',tipo:'1x/riposo lungo',
  ...
  {id:'w_d02',upgradeOnly:true,nome:'Arco',nomeLore:'Arco di Asteria',cat:'DX',tipo:'Arco',    stile:'fantasy',
   ...
   perkSpeciale:{nome:'Freccia Inevitabile',tipo:'1x/riposo lungo',
  ...
  {id:'w_d03',upgradeOnly:true,nome:'Maglio',nomeLore:'Tuono Silente',cat:'DX',tipo:'Maglio',   stile:'fantasy',
   ...
   perkSpeciale:{nome:'Scarica Paralizzante',tipo:'1x/riposo lungo',
  ...
  {id:'w_d05',upgradeOnly:true,nome:'Fucile ad Alta Energia',nomeLore:'Ragnarok-7',cat:'DX',tipo:'Fucile Prototipo',stile:'cyberpunk',
   ...
   perkSpeciale:{nome:'Colpo di Plasma',tipo:'1x/riposo lungo',
  ...
  {id:'w_d06',upgradeOnly:true,nome:'Nodachi',nomeLore:'Occhio del Drago',cat:'DX',tipo:'Spada', stile:'anime',
   ...
   perkSpeciale:{nome:'Passo del Drago',tipo:'1x/riposo lungo',
  ...
  {id:'w_d07',upgradeOnly:true,nome:'Katana',nomeLore:'Fato Infranto',cat:'DX',tipo:'Spada',    stile:'anime',
   ...
   perkSpeciale:{nome:'Recisione del Ki',tipo:'1x/riposo lungo',
  ...
  {id:'w_d08',upgradeOnly:true,nome:'Falce',nomeLore:'Lama del Vuoto',cat:'DX',tipo:'Falce',    stile:'horror',
   ...
   perkSpeciale:{nome:'Mietitore',tipo:'1x/riposo lungo',
  ...
  {id:'w_d09',upgradeOnly:true,nome:'Pugnale Rituale',nomeLore:'Marchio di Abaddon',cat:'DX',tipo:'Pugnale',stile:'horror',
   ...
   perkSpeciale:{nome:'Segnatura Demoniaca',tipo:'1x/riposo lungo',
  ...
  {id:'w_d10',upgradeOnly:true,nome:'Revolver',nomeLore:'Il Giustiziere',cat:'DX',tipo:'Revolver',stile:'noir',
   ...
   perkSpeciale:{nome:'Colpo del Giustiziere',tipo:'1x/riposo lungo',
