...
var AUGMENTS = [
  ...
  {id:'aug_bm',stile:'cyberpunk',tipo:'Cyberware',nome:'Braccio Meccanico',desc:'Esoscheletro. Forza idraulica.',pro:'+2 CORPO attacchi fisici. Solleva il doppio.',con:'-1 ANIMA formale. -1 CORPO stealth.',manutenzione:'Calibrazione settimanale.',perk:'Presa Idraulica: 1x/combat, se colpisci in mischia il bersaglio e Rallentato 1 round.'},
  ...
  {id:'aug_gp',stile:'cyberpunk',tipo:'Cyberware',nome:'Gambe Potenziate',desc:'Servoassistite. Salti 3m, velocita doppia.',pro:'Movimento doppio. +3 CORPO salto.',con:'-2 CORPO stealth in corsa.',manutenzione:'Ammortizzatori settimanali.',perk:'Carica Devastante: se ti muovi di almeno 6m prima di attaccare, +2 al tiro.'},
  ...
  {id:'aug_lp',stile:'fantasy',tipo:'Bioware',nome:'Tessuto Licantropo',desc:'Rigenerazione licantropa.',pro:'Rigenera 1 HP/round fuori combat. Artigli Cat A.',con:'-1 MENTE in luna piena. ANIMA vs 8 o perdi controllo.',manutenzione:null,perk:'Frenesia Lunare: sotto meta HP, +1 attacchi fisici (cumulabile con Furia).'},
  ...
  // HORROR
  {id:'aug_pm',stile:'horror',tipo:'Patto',nome:'Patto col Morto',desc:'Accordo con entita.',pro:'1x/sessione: info unica. +1 difesa ANIMA.',con:'Entita puo interferire.',manutenzione:'Rispetta patti o -2 tiri.',perk:'Sussurro del Morto: 1x/combat, ANIMA vs ANIMA di un nemico, vinci: conosci la sua prossima azione.'},
  ...
  {id:'aug_nm',stile:'horror',tipo:'Neurologia',nome:'Nervo Morto',desc:'Anestetizzazione dolore.',pro:'Immune penalita Ferito. +1 CORPO resistenza.',con:'Non senti danni minori. Ferite nascoste (GM).',manutenzione:null,perk:'Resistenza al Dolore: 1x/combat, ignora una condizione per 1 round.'},
  {id:'aug_sc',stile:'horror',tipo:'Patto',nome:'Sigillo Corrotto',desc:'Sigillo magico oscuro.',pro:'+2 a tipo tiro scelto. Sempre attivo.',con:'Ad ogni uso: d6, su 1 entita guarda attraverso te.',manutenzione:null,perk:'Marchio Ardente: 1x/combat, il bersaglio che colpisci subisce -1 a tutti i tiri per 2 round.'},
  {id:'aug_mk',stile:'horror',tipo:'Patto Cosmico',nome:'Marchio dell\'Antico',desc:'Simbolo entita cosmica.',pro:'+2 ANIMA vs entita cosmiche. Percepisci elder god 500m.',con:'-1 MENTE per sessione. Sogni cosmici.',manutenzione:'Rituali mensili.',perk:'Terrore Cosmico: 1x/sessione, ANIMA vs ANIMA di tutti entro 5m, chi perde e Spaventato 1 round.'},
  ...
  {id:'aug_sang',stile:'horror',tipo:'Rituale di Setta',nome:'Legame di Sangue',desc:'Rete psichica di setta.',pro:'Senti membri 1 km. +2 ANIMA rituali collettivi.',con:'Setta ti localizza sempre. GM ha accesso pensieri.',manutenzione:'Rito mensile.',perk:'Rete Psichica: 1x/combat, un membro della setta entro 1km ti da +2 al prossimo tiro.'},
  {id:'aug_corp',stile:'horror',tipo:'Corruzione',nome:'Corruzione Benedetta',desc:'Corpo parzialmente corrotto.',pro:'+1 CORPO, +1 ANIMA. Rigenera 1 HP/round sotto meta HP.',con:'Rigenerazione: d6, su 1 tratto orrorifico. Non-umano.',manutenzione:null,perk:'Rigetto Violento: quando rigeneri HP, 1x/combat il nemico piu vicino subisce 2 danni.'},
  {id:'aug_voc',stile:'horror',tipo:'Rituale di Setta',nome:'Voce dell\'Abisso',desc:'Voce modificata da rituale.',pro:'+3 ANIMA intimidazione. Vero Nome: entita non attacca 1 round.',con:'-2 ANIMA social normali. Attira attenzione entita.',manutenzione:null,perk:'Comando Abissale: 1x/sessione, pronuncia un ordine: ANIMA vs ANIMA, il bersaglio esegue 1 azione semplice.'},
  // ANIME
  {id:'aug_lr',stile:'anime',tipo:'Neurologia',nome:'Limitatore Rimosso',desc:'Blocco mentale rimosso.',pro:'1x/combat: stat bonus x1.5 per 1 round.',con:'-5 HP dopo. Incomp. Riflessi Neurali / Gate.',manutenzione:null,perk:'Sovraccarico: quando usi il Limitatore, il primo attacco del round extra ha +3.'},
  ...
  {id:'aug_ck',stile:'anime',tipo:'Spirituale',nome:'Core di Ki',desc:'Riserva energia spirituale.',pro:'+2 attacchi magici. Usa stat piu alta per magie.',con:'2 magie consecutive: -2 HP. Ki visibile.',manutenzione:null,perk:'Esplosione di Ki: 1x/combat, il tuo prossimo attacco magico colpisce anche 1 bersaglio adiacente.'},
  ...
  {id:'aug_spirit',stile:'anime',tipo:'Spirituale',nome:'Spirito dell\'Arma',desc:'Arma con coscienza.',pro:'+2 attacchi fisici. +1 iniziativa. 1x/sessione nega critico.',con:'Spirito ha volonta propria (GM). Se distrutta: -bonus 1 sessione.',manutenzione:'Cura narrativa.',perk:'Risonanza: 1x/combat, l\'arma agisce da sola come azione bonus (Cat A, +2 attacco).'},
  {id:'aug_gate',stile:'anime',tipo:'Energia Interiore',nome:'Gate dell\'Anima',desc:'Canali energetici potenziati.',pro:'+1 tutti tiri. Azione: apri gate +4 attacco 1 round.',con:'Gate: -3 HP. 3+ aperture/sessione: -1 CORPO. Incomp. Limitatore.',manutenzione:'Meditazione. Senza: -5 HP.',perk:'Canale Aperto: quando apri il Gate, il prossimo alleato che attacca il tuo bersaglio ha +2.'},
  ...
  {id:'aug_ws',stile:'universale',tipo:'Biologico',nome:'Cicatrice della Guerra',desc:'Segni permanenti.',pro:'+1 CORPO. Immune Ferito in primo combat/sessione.',con:'-1 ANIMA vs non-combattenti. Trigger: -1 MENTE 1 round.',manutenzione:null,perk:'Veterano: 1x/combat, +2 al prossimo tiro contro un nemico che ti ha gia colpito.'},
